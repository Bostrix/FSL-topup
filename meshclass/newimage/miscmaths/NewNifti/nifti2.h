...
/*! \struct nifti_2_header
    \brief Data structure defining the fields in the nifti2 header.
           ...
           NIFTI-2 header file.
 */
#ifndef __FSL_NIFTI2_HEADER__
#define __FSL_NIFTI2_HEADER__
...
enum {
  NIFTI_INTENT_CONNECTIVITY_DENSE = 3001,
  NIFTI_INTENT_CONNECTIVITY_DENSE_TIME = 3002,
  NIFTI_INTENT_CONNECTIVITY_PARCELLATED = 3003,
  NIFTI_INTENT_CONNECTIVITY_PARCELLATED_TIME = 3004,
  NIFTI_INTENT_CONNECTIVITY_CONNECTIVITY_TRAJECTORY = 3005,
