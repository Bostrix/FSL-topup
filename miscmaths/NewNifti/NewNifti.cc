...
namespace NiftiIO {
  ...
  size_t NiftiHeader::datumByteWidth() const{
  ...
  string NiftiHeader::niftiIntentString() const {
    switch( intentCode ){
      ...
      case NIFTI_INTENT_TIME_SERIES:  return "Timeseries";
      ...
      case NIFTI_INTENT_FSL_FNIRT_DISPLACEMENT_FIELD:
                                      return "FSL FNIRT field";
      case NIFTI_INTENT_FSL_CUBIC_SPLINE_COEFFICIENTS:
                                      return "FSL cubic coefficent";
      case NIFTI_INTENT_FSL_DCT_COEFFICIENTS:
                                      return "FSL DCT coefficent";
      case NIFTI_INTENT_FSL_QUADRATIC_SPLINE_COEFFICIENTS:
                                      return "FSL quadratic coefficent";
      case NIFTI_INTENT_FSL_TOPUP_CUBIC_SPLINE_COEFFICIENTS:
                                      return "FSL topup cubic spline";
      case NIFTI_INTENT_FSL_TOPUP_QUADRATIC_SPLINE_COEFFICIENTS:
                                      return "FSL topup quadratic spline";
      case NIFTI_INTENT_FSL_TOPUP_FIELD:
                                      return "FSL topup field";
    }
    return "Unknown" ;
  }
  ...
  string NiftiHeader::niftiTransformString(const int transform) const {
    switch( transform ) {
      ...
      case NIFTI_XFORM_TEMPLATE_OTHER:  return "Template Other";
    }
    return "Unknown" ;
  }
